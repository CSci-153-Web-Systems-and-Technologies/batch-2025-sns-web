    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      <div>
        <Link
          ...
          className="inline-flex items-center text-sm text-gray-500 hover:text-[#146939] transition-colors mb-4"
        >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-gray-200 pb-6">
          ...
          <div className="flex gap-3">
            <Button
              variant="outline"
              className="border-gray-300 text-gray-700 hover:bg-gray-50 font-montserrat"
            >
              Class Settings
            </Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  students.map((student: any) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-[#17321A] font-montserrat">
                            {student.full_name}
                          </p>
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-[#146939]"
                      >
        ...
        <div className="space-y-6">
          <Card className="bg-[#17321A] text-white border-none shadow-xl relative overflow-hidden">
            ...
            <CardContent className="space-y-4 relative z-10">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-xl font-bold font-montserrat text-amber-400">
                  12
                </span>
              </div>
            </CardContent>
          ...
          <Card className="border-gray-200">
            <CardHeader>
              <CardTitle className="text-md font-bold text-[#17321A] font-montserrat">
                Recent Activity
              </CardTitle>
            </CardHeader>
