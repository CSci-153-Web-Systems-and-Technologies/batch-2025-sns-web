  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#17321A] font-montserrat">
            Dashboard
          </h1>
          <p className="text-gray-500 font-roboto mt-1">
            Welcome back, Professor Smith. Here's what's happening today.
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <CardContent>
              <div className="text-2xl font-bold font-roboto text-[#17321A]">
                {stat.value}
              </div>
      ...
      <div className="grid gap-4 md:grid-cols-7">
        <Card className="md:col-span-4 lg:col-span-5 border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-[#17321A] font-montserrat">
              Recent Exams
            </CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              {recentExams.map((exam, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-4 bg-gray-50 rounded-lg group hover:bg-white hover:shadow-sm border border-transparent hover:border-gray-100 transition-all"
                >
        ...
        <Card className="md:col-span-3 lg:col-span-2 bg-[#17321A] text-white border-none shadow-lg relative overflow-hidden">
          ...
          <CardHeader>
            ...
            <CardDescription className="text-gray-300 font-roboto text-xs">
          ...
          <CardContent className="grid gap-3">
            <Button
              variant="secondary"
              className="w-full justify-between hover:bg-gray-100 font-montserrat text-[#17321A]"
            >
              Create New Exam <PlusCircle className="h-4 w-4" />
            </Button>
            <Button
              variant="ghost"
              className="w-full justify-between text-white hover:text-white hover:bg-[#146939] font-montserrat border border-[#146939]"
            >
              View Reports <ArrowRight className="h-4 w-4" />
            </Button>

            <div className="mt-6 pt-6 border-t border-[#146939]">
              <h4 className="font-bold text-sm mb-2 font-montserrat text-[#00954f]">
                Did you know?
              </h4>
              <p className="text-xs text-gray-300 font-roboto leading-relaxed">
                You can now bulk-import student scores using CSV format in the
                Students tab.
              </p>
            </div>
          </CardContent>
