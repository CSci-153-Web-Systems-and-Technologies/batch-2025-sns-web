...
export function ClassesPageContent({
  ...
  const handleArchive = async (classId: string) => {
    if (
      confirm(
        "Are you sure you want to archive this class? It will be hidden from the active list."
      )
    ) {
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <CardHeader className="flex flex-row items-start justify-between pb-2">
              <div className="space-y-1">
                <CardTitle
                  className="text-xl font-bold text-[#17321A] font-montserrat line-clamp-1"
                  title={cls.name}
                >
                  {cls.name}
                </CardTitle>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="h-8 w-8 p-0 text-gray-400 hover:text-[#17321A] hover:bg-[#e6f4ea] transition-colors cursor-pointer"
                  >
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-48 border-gray-100 shadow-lg animate-in slide-in-from-top-1"
                >
                  <DropdownMenuItem
        ...
        >
          ...
          <div className="text-center">
            <span className="block font-bold font-montserrat text-lg">
              Create New Class
            </span>
            <span className="text-sm font-roboto opacity-70">
