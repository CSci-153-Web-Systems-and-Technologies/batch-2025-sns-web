    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10 max-w-5xl mx-auto">
      <div>
        <Link
          ...
          className="inline-flex items-center text-sm text-gray-500 hover:text-[#146939] transition-colors mb-6 group"
        >
              ...
              {filteredStudents.length === 0 ? (
                <div className="p-12 text-center text-gray-500 font-roboto flex flex-col items-center justify-center h-64">
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Try searching for a different name or add a new student.
                  </p>
                  <Button
                    variant="link"
                    onClick={() => setIsManageOpen(true)}
                ...
                <div className="divide-y divide-gray-50">
                  {filteredStudents.map((student) => (
                    <div
                      key={student.id}
                      className="p-4 px-6 flex items-center justify-between hover:bg-[#e6f4ea]/30 transition-colors group"
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-[#17321A] font-montserrat text-sm">
                            {student.full_name}
                          </p>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-[#146939] hover:bg-[#e6f4ea] rounded-lg h-8 w-8 p-0 transition-all cursor-pointer"
                          >
