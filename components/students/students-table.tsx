          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50/50 text-gray-500 font-montserrat uppercase text-xs border-b border-gray-100">
              <tr>
                ...
                <th className="px-6 py-4 font-bold text-[#17321A] text-right">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {paginatedStudents.length === 0 ? (
                <tr>
                  <td
                    colSpan={6}
                    className="px-6 py-12 text-center text-gray-500 font-roboto"
                  >
                ...
                paginatedStudents.map((student) => (
                  <tr
                    key={student.id}
                    className="group hover:bg-[#e6f4ea]/30 transition-colors"
                  >
                        ...
                        {student.enrolled_classes.length > 0 ? (
                          student.enrolled_classes
                            ...
                            .map((code, i) => (
                              <span
                                key={i}
                                className="text-[10px] font-bold px-1.5 py-0.5 bg-[#e6f4ea] text-[#146939] rounded border border-[#146939]/10"
                              >
                                {code}
                              </span>
                            ))
                    ...
                    <td className="px-6 py-4 text-right">
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            className="h-8 w-8 p-0 text-gray-400 hover:text-[#146939] hover:bg-[#e6f4ea] rounded-lg transition-colors cursor-pointer"
                          >
