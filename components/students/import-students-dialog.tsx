...
export function ImportStudentsDialog({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] transform flex flex-col max-h-[90vh] mx-4", // Responsive sizing and fluid animation
          isVisible
        ...
        <div className="px-6 pt-8 pb-2 flex justify-between items-start shrink-0">
          <div>
            ...
            <p className="text-sm text-gray-500 font-roboto mt-1">
              Bulk add students via CSV file.
            </p>
          </div>
          <button
        ...
        <div className="p-6 space-y-6 flex-1 overflow-y-auto custom-scrollbar">
          <div
            ...
            className={cn(
              ...
              file
                ? "border-[#146939] bg-[#e6f4ea]/30"
                : "border-gray-200 hover:border-[#146939] hover:bg-gray-50"
            )}
          >
            <input
              ref={fileInputRef}
            ...
            <div
              className={cn(
                ...
                file
                  ...
                  : "bg-gray-100 text-gray-400 group-hover:text-[#146939] group-hover:bg-[#e6f4ea]"
              )}
            >
              {file ? (
            ...
            {file ? (
              <div>
                <p className="font-semibold text-[#17321A] text-sm truncate">
                  {file.name}
                </p>
