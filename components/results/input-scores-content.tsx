    ...
    <div className="space-y-8 animate-in fade-in pb-10 max-w-4xl mx-auto">
      <div>
        <Link
          ...
          className="inline-flex items-center text-sm text-gray-500 hover:text-[#146939] mb-6 group"
        >
        ...
        <div className="flex justify-between items-end">
          <div>
            ...
            <p className="text-gray-500 font-roboto mt-1">
              Input scores for {exam.class_code}
            </p>
          </div>
          <div className="flex gap-3">
            <Button
              onClick={handleSave}
              disabled={saving}
              className="bg-[#146939] hover:bg-[#00954f] text-white rounded-xl h-11 px-6 shadow-md"
            >
      ...
      <Card className="rounded-2xl border-gray-100 shadow-sm overflow-hidden bg-white">
        ...
        <div className="divide-y divide-gray-50">
          {students.map((student) => (
            <div
              key={student.id}
              className="flex items-center justify-between px-6 py-4 hover:bg-[#e6f4ea]/20 transition-colors"
            >
