...
export function InputScoresContent({
  exam,
  students,
  allStudents,
  classId,
    ...
    <div className="space-y-8 animate-in fade-in pb-10 max-w-5xl mx-auto">
      <div>
        <Link
          ...
          className="inline-flex items-center text-sm text-gray-500 hover:text-[#146939] mb-6 group transition-colors"
        >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
          <div>
            ...
            <p className="text-gray-500 font-roboto mt-1">
              Input scores for{" "}
              <span className="font-semibold text-[#17321A]">
                {exam.class_code}
              </span>
            </p>
          </div>
        ...
        <div className="divide-y divide-gray-50 max-h-[60vh] overflow-y-auto custom-scrollbar">
          {students.length === 0 ? (
            ...
            students.map((student) => (
              <div
                key={student.id}
                className="flex items-center justify-between px-6 py-4 hover:bg-[#e6f4ea]/20 transition-colors group"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-[#17321A] font-montserrat">
                      {student.full_name}
                    </p>
                ...
                <div className="w-24 relative">
                  <Input
                    ...
                    className={cn(
                      ...
                      scores[student.id] !== ""
                        ? "bg-[#e6f4ea]/50 border-[#146939]/30 text-[#146939]"
                        : ""
                    )}
                  />
                </div>
