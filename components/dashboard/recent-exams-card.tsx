    ...
    <Card className="md:col-span-4 lg:col-span-5 border border-gray-200 shadow-sm bg-white">
      <CardHeader className="border-b border-gray-50 pb-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            className="text-[#00954f] hover:text-[#17321A] hover:bg-[#e6f4ea] font-montserrat text-xs font-semibold cursor-pointer"
          >
            View All
          </Button>
        </div>
      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          {recentExams.map((exam, i) => (
            <div
              key={i}
              className="flex items-center justify-between p-4 bg-gray-50/50 rounded-xl border border-gray-100 hover:border-[#00954f]/30 hover:bg-white hover:shadow-sm transition-all group cursor-pointer"
            >
