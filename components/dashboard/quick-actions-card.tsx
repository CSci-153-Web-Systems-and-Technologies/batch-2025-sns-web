...
export function QuickActionsCard() {
  return (
    <Card className="md:col-span-3 lg:col-span-2 bg-gradient-to-t from-[#146939] to-[#17321A] text-white border-none shadow-xl relative overflow-hidden flex flex-col justify-between">
      ...
      <CardHeader className="relative z-10">
        ...
        <CardDescription className="text-gray-100 font-roboto text-xs border-l-2 border-white/50 pl-2 mt-1">
      ...
      <CardContent className="grid gap-4 relative z-10">
        ...
        <Link href="/dashboard/results" className="w-full">
          <Button
            variant="outline"
            className="w-full justify-between bg-transparent border-white/30 text-white hover:bg-white/10 hover:text-white hover:border-white font-montserrat h-12 cursor-pointer"
          >
            Send Scores
        ...
        <Link href="/dashboard/reports" className="w-full">
          <Button
            variant="ghost"
            className="w-full justify-start px-0 text-gray-200 hover:text-white hover:bg-transparent font-roboto text-xs uppercase tracking-wider cursor-pointer"
          >
      ...
      <div className="relative z-10 p-6 pt-0">
        <div className="p-3 rounded-lg bg-black/20 backdrop-blur-sm border border-white/10">
          ...
          <p className="text-[10px] text-gray-100 font-roboto leading-relaxed opacity-90">
            Bulk-import student scores using CSV format in the Students tab to
            save time.
          </p>
        </div>
      </div>
