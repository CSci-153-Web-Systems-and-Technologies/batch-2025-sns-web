    ...
    <Card className="md:col-span-3 lg:col-span-2 bg-[#17321A] text-white border-none shadow-xl relative overflow-hidden flex flex-col justify-between">
      ...
      <CardContent className="grid gap-4 relative z-10">
        ...
        <Link href="/dashboard/results" className="w-full">
          <Button
            variant="outline"
            className="w-full justify-between bg-transparent border-gray-600 text-white hover:bg-[#146939] hover:text-white hover:border-[#146939] font-montserrat h-12 cursor-pointer"
          >
            Send Scores
        ...
        <Link href="/dashboard/reports" className="w-full">
          <Button
            variant="ghost"
            className="w-full justify-start px-0 text-gray-300 hover:text-white hover:bg-transparent font-roboto text-xs uppercase tracking-wider cursor-pointer"
          >
