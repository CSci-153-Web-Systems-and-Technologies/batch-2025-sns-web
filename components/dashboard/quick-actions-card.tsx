    ...
    <Card className="md:col-span-3 lg:col-span-2 border border-gray-200 shadow-sm bg-white rounded-2xl h-full">
      ...
      <CardContent className="space-y-4">
        <Link href="/dashboard/exams" className="block w-full">
          <Button className="w-full justify-start bg-[#146939] hover:bg-[#00954f] text-white font-montserrat h-12 rounded-xl shadow-md hover:shadow-lg transition-all group">
