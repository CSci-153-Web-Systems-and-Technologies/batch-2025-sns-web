    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full md:translate-x-0 bg-gradient-to-b from-[#146939] to-[#17321A] text-white transition-all duration-300 flex flex-col shadow-2xl border-r border-[#146939]">
      ...
      <div className="p-4 border-t border-[#146939]/50 bg-[#146939]/10">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-red-300/80 hover:text-red-200 hover:bg-red-500/10 rounded-xl transition-all duration-300 group font-montserrat cursor-pointer hover:shadow-inner"
        >
          <LogOut className="h-4 w-4 transition-transform group-hover:-translate-x-1" />
          <span>Sign Out</span>
        </button>
        <p className="text-[10px] text-[#146939] text-center mt-3 font-roboto opacity-60">
          © 2024 SNS System
        </p>
      </div>
    </aside>
