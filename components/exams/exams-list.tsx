  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      {exams.map((exam) => (
        <Card
          key={exam.id}
          className="group border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 bg-white hover:-translate-y-1 overflow-hidden"
        >
          <div
          ...
          <CardFooter className="pt-3 border-t border-gray-50 bg-gray-50/50 flex justify-between items-center">
            ...
            <Button
              variant="ghost"
              className="text-[#146939] hover:text-[#00954f] font-montserrat text-xs font-bold"
            >
              Manage
            </Button>
          </CardFooter>
